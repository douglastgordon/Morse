...
const makeGuide = () => {
  ...
  Object.entries(_src_translation__WEBPACK_IMPORTED_MODULE_0__["englishMorseDictionary"]).forEach(entry => {
    ...
    morse.split("").forEach(ditDah => {
      ...
      ditDahNode.classList.add(ditDah === _src_translation__WEBPACK_IMPORTED_MODULE_0__["DIT"] ? "dit" : "dah");
...
/*!****************************!*\
  !*** ./src/translation.js ***!
  \****************************/
/*! exports provided: englishMorseDictionary, DIT, ON, OFF, parseDurations */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
